...
void NV21TextureMapSample::Init() {
    ...
    m_ySamplerLoc = glGetAttribLocation(m_ProgramObj, "y_texture");
    m_uvSamplerLoc = glGetAttribLocation(m_ProgramObj, "uv_texture");

    GLuint textureIds[2] = {0};
    glGenTextures(2, textureIds);

    m_yTextureId = textureIds[0];
    m_yTextureId = textureIds[1];
